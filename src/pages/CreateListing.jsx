    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <textarea
          ...
          required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded
        transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-4"
        />
        ...
        <div className="mb-6">
          ...
          transition duration-150 ease-in-out focue:bg-white focus:border-slate-600"
          />
        </div>
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md
        hover:bg-blue-700 hover:shodow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg
